...
UCLASS()
class MAIN_API UGI : public UGameInstance
{
	GENERATED_BODY()
	
	public:
	//Constructor
	UGI(const FObjectInitializer& ObjectInitializer);

	virtual void Init() override;
	/* Widget references */
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "State Manager")
	TSubclassOf<class UUserWidget> mLogin;
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "State Manager")
	TSubclassOf<class UUserWidget> mMainMenu;
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "State Manager")
	TSubclassOf<class UUserWidget> mMPHome;
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "State Manager")
	TSubclassOf<class UUserWidget> mMPJoin;
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "State Manager")
	TSubclassOf<class UUserWidget> mMPHost;
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "State Manager")
	TSubclassOf<class UUserWidget> mLoadingScreen;
